...
theta4 = pi/4;
theta5 = pi/4;
ys_ori = [theta1; theta2; theta3; theta4; theta5];
nlink = 5;
...
for i = 1:sample_num
    ...
    xpos_per = cos(ys_pert(1)) + cos(ys_pert(2)) + cos(ys_pert(3)) + cos(ys_pert(4)) + cos(ys_pert(5));
    ypos_per = sin(ys_pert(1)) + sin(ys_pert(2)) + sin(ys_pert(3)) + sin(ys_pert(4)) + sin(ys_pert(5));
